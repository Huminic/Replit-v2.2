...
Ghost for nexxus2.2_replit is deterministic verification.
Ghost does not invent policy.
Ghost reports checks, violations, and recommended control-plane actions.
