...
- **Multi-Store Architecture**: 5 stores with data isolation (Serra Honda/Serra, Serra Nissan/Aria, Tony Serra Ford/Nova, Hyundai of Columbia/Aria, Ford of Columbia/Nova). NOTE: Hyundai of Columbia has NO Tavus persona linked (tavusPersonaId is null) — video widget shows error state for that store.
