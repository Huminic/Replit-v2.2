...
- Verdict: CONFIRMED
- Evidence: `FLEXPRICE_API_KEY=REDACTED-FLEXPRICE-API-KEY`
...
- Evidence:
```
VITE_VAPI_PUBLIC_KEY=REDACTED-VAPI-PUBLIC-KEY
TAVUS_API_KEY=REDACTED-TAVUS-API-KEY
TAVUS_WEBHOOK_SECRET=REDACTED-TAVUS-WEBHOOK-SECRET
FLEXPRICE_API_KEY=REDACTED-FLEXPRICE-API-KEY
