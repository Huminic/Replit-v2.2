...
export const staticWidgets: IndividualWidget[] = [
  {
    ...
    allowedDomains: [],
    config: { agentName: 'AI Assistant', aiInstructions: 'You are a helpful automotive sales assistant.' },
  ...
  },
  {
    ...
    allowedDomains: [],
    config: { tavusPersonaId: '', tavusPersonaName: 'AI Concierge' },
  ...
  },
  {
    ...
    allowedDomains: [],
    config: { vapiAssistantId: '', vapiPublicKey: '', phoneDisplay: '' },
