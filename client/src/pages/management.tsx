 ...
 *   - Activities: Recent team/agent actions across all departments using mockActivityFeed from activity.ts
...
export default function ManagementPage() {
  ...
  /** Activities tab — uses mockActivityFeed from activity.ts to show recent team/agent actions across all departments */
