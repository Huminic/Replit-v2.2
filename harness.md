...
|------|-----------------|-------|
| pre-execution-report.md | Timestamp, Sprint, Status: READY, ## Declared Files, ## UI Changes (if applicable) | Written BEFORE code changes |
| post-sprint-report.md | Timestamp, Sprint, Status: COMPLETE, AC results with evidence references | Written after work is done |
